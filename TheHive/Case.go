...
//
// Returns HiveCase struct and response error
func (hive *HiveCase) GetCase(case_id string) (*HiveCaseResp, error) {
...
func (hive *HiveCase) FindCases(search []byte) (*HiveCaseRespMulti, error) {
...
func (hive *HiveCase) AddCustomFieldData(caseId string, name string, data string) (*HiveCase, error) {
...
func (hive *HiveCase) PatchCaseFieldInt(alertId string, field string, value int64) (*HiveCase, error) {
